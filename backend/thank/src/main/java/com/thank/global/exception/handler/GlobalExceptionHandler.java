package com.thank.global.exception.handler;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({IllegalArgumentException.class, ThankException.class})
    protected ResponseEntity<EnvelopRes<String>> handleIllegalArgumentException(ThankException e) {
